...
from models.utils.losses import uPULoss 

class uPUFedAvg(FederatedModel):
   
    NAME = 'upu_fedavg'
    COMPATIBILITY = ['homogeneity']

    def __init__(self, nets_list, args, transform):
        super(uPUFedAvg, self).__init__(nets_list, args, transform)
